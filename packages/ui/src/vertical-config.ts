...
export const VERTICAL_IDS = ["agency", "restaurant", "service_pro", "florist"] as const;
...
const VERTICAL_CONFIGS: Record<VerticalId, VerticalConfig> = {
  agency: verticalConfigSchema.parse({
    id: "agency",
    displayName: "Agency",
    terminology: { prospect: "Prospect", prospects: "Prospects", pipeline: "Pipeline" },
    enabledModules: [
      ...CORE,
      "backlink_audit",
      "lighthouse_audit",
  ...
  restaurant: verticalConfigSchema.parse({
    ...
    terminology: { prospect: "Customer", prospects: "Customers", pipeline: "Orders" },
