...
export type ServiceProLeadMetadata = z.infer<
	typeof servicePtoLeadMetadataSchema
>;
export type RestaurantLeadMetadata = z.infer<
	typeof restaurantLeadMetadataSchema
>;
