...
const serviceFoundation: LongformSection[] = [
	...
	{
		heading:
			"Local SEO alignment: website, profile, and geography working together",
		paragraphs: [
	...
	{
		heading:
			"Authority and proof: building trust signals that survive comparison",
		paragraphs: [
...
const blogExpansion: LongformSection[] = [
	{
		heading:
			"Operational context: why this topic matters in real lead generation",
		paragraphs: [
	...
	{
		heading:
			"Execution framework: how to turn guidance into page-level changes",
		paragraphs: [
	...
	{
		heading:
			"Local relevance: translating broad advice into market-specific actions",
		paragraphs: [
...
const universalDepthAddendum: LongformSection[] = [
	...
	{
		heading:
			"Implementation depth: how these standards improve mobile-first performance",
		paragraphs: [
