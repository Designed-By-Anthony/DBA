...
export function FoundingPartnerSection() {
	return (
		<section className="section-shell founding-partner-shell" aria-labelledby="founding-partner-heading">
			<div className="section-container">
				<div className="section-header centered founding-partner-header">
				...
				<div className="founding-pillars">
					<article className="founding-pillar">
					...
					<article className="founding-pillar founding-pillar--growth">
						<div
						...
						<h3 className="founding-pillar-title">
							<span className="founding-pillar-price">{FOUNDING_PARTNER_SEO_MONTHLY}</span>
							/mo {FOUNDING_PARTNER_SEO_LABEL}
						</h3>
						<p className="founding-pillar-lede">
							Ongoing visibility and care: Google Cloud hosting, security, and SEO—plus Google
							Business Profile attention, review support, and one meaningful growth asset each month.
						</p>
						<ul className="founding-pillar-list">
