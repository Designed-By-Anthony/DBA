...
export function initLayoutCalendlyEmbed(): void {
  const modal = document.getElementById('layoutCalendlyModal') || document.getElementById('calendlyModal');
  const body =
  ...
  document.addEventListener('click', (event: MouseEvent) => {
    ...
    const trigger = target.closest('[data-calendar-link][data-calendly-href]') as HTMLElement | null;
