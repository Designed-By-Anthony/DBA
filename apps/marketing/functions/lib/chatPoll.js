 ...
 */
exports.chatPoll = (0, https_1.onRequest)({ cors: true }, async (req, res) => {
    var _a;
    ...
    try {
        ...
        const mode = sessionDoc.exists ? (((_a = sessionDoc.data()) === null || _a === void 0 ? void 0 : _a.mode) || 'bot') : 'bot';
        ...
        const messages = snapshot.docs.map(doc => {
            ...
            return {
                id: doc.id,
                text: data.text,
                timestamp: ((_a = data.timestamp) === null || _a === void 0 ? void 0 : _a.toMillis()) || Date.now()
            };
        });
...
//# sourceMappingURL=chatPoll.js.map