...
exports.chatAppListener = void 0;
 ...
 */
exports.chatAppListener = (0, https_1.onRequest)({ cors: true }, async (req, res) => {
    var _a;
    if (req.method !== 'POST') {
    ...
    const threadKey = (_a = chatMessage.thread) === null || _a === void 0 ? void 0 : _a.threadKey;
    if (!threadKey) {
...
//# sourceMappingURL=chatAppListener.js.map