...
(async () => {
  ...
  const sites = [
    { url: 'https://landscape-demo.web.app/', file: 'public/images/landscape_demo.png' },
    { url: 'https://plumber-demo-404e2.web.app/', file: 'public/images/plumber_demo.png' },
    { url: 'https://roofer-demo.web.app/', file: 'public/images/roofer_demo.png' }
  ];
