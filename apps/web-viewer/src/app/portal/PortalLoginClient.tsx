    ...
    <div className="flex items-center justify-center min-h-[60vh] relative">
      ...
      <div className="glass-card p-8 max-w-md w-full animate-scale-in relative">
        ...
        <div
          ...
          style={{ background: `linear-gradient(to right, transparent, ${branding.brandColor}, transparent)` }}
        />
        ...
        <div className="text-center mb-6">
          ...
          <h1 className="text-xl font-bold text-white mb-1">{branding.brandName}</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="portal-email" className="text-xs text-text-muted uppercase tracking-wider block mb-1.5">
              Email Address
            </label>
            <input
              id="portal-email"
        ...
        <p className="text-xs text-text-muted text-center mt-6">
          No account? Contact{" "}
          <a href={`mailto:${brandConfig.supportEmail}`} className="hover:underline" style={{ color: branding.brandColor }}>
