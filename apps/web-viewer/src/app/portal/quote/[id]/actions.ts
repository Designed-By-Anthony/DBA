 ...
 */
export async function acceptQuoteAndCheckoutAction(_params: {
  quoteId: string;
  prospectId: string;
  packageId: string;
  ...
  return {
    url: null,
    error: "Quote acceptance is temporarily unavailable during the database migration. Please contact support.",
  };
}
