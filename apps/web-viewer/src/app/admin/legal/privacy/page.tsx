    ...
    <div className="max-w-3xl mx-auto py-12 px-6 text-[var(--color-text-secondary)]">
      ...
      <section className="space-y-6 leading-relaxed text-sm">
        <div>
          ...
          <p><strong className="text-white">Account Information:</strong> Name, email address, organization name, and billing details provided during registration via Clerk authentication.</p>
          <p className="mt-2"><strong className="text-white">CRM Data:</strong> Leads, contacts, appointments, orders, inventory, and other business data you input. This data belongs to you and is scoped exclusively to your organization.</p>
          <p className="mt-2"><strong className="text-white">Usage Data:</strong> Page views, feature usage, error logs, and performance metrics collected via Sentry and Vercel Analytics (no PII is logged at info level).</p>
          <p className="mt-2"><strong className="text-white">Files & Media:</strong> Images, PDFs, and documents uploaded are stored in Cloudflare R2 object storage. Only URL references are stored in our database.</p>
        </div>

        <div>
          <h2 className="text-lg font-semibold text-white mb-2">2. How We Use Your Information</h2>
          <ul className="list-disc pl-6 space-y-1">
            <li>Provide, operate, and maintain the {c.platformName} platform</li>
            <li>Process transactions and send related information (receipts, invoices)</li>
            <li>Send email communications you initiate through our CRM tools</li>
        ...
        <div>
          ...
          <ul className="list-disc pl-6 mt-2 space-y-1">
            ...
            <li><strong className="text-white">Neon</strong> — Database hosting (encrypted in transit and at rest)</li>
            <li><strong className="text-white">Cloudflare R2</strong> — File and media storage</li>
            <li><strong className="text-white">Resend</strong> — Transactional and marketing email delivery</li>
            <li><strong className="text-white">Sentry</strong> — Error monitoring (PII is scrubbed)</li>
            <li><strong className="text-white">Vercel</strong> — Application hosting and analytics</li>
            <li><strong className="text-white">Google Gemini</strong> — AI-powered onboarding assistance (conversation data is not stored by Google)</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>Row-level security (RLS) enforces strict tenant data isolation</li>
        ...
        <div>
          ...
          <ul className="list-disc pl-6 mt-2 space-y-1">
            ...
            <li><strong className="text-white">Deletion</strong> — Request deletion of your data (&ldquo;right to be forgotten&rdquo;)</li>
          ...
          <p className="mt-2">
            ...
            <a href={`mailto:${c.privacyEmail}`} className="text-[var(--color-brand)] hover:underline">
              {c.privacyEmail}
            </a>
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            We use essential cookies for authentication (Clerk session) and preferences.
            We do not use advertising or third-party tracking cookies. Vercel Analytics
            uses privacy-friendly, cookie-less tracking.
          </p>
        </div>
        ...
        <div>
          <h2 className="text-lg font-semibold text-white mb-2">9. CAN-SPAM Compliance</h2>
          <p>
            All marketing emails sent through {c.platformName} include: a valid physical
            mailing address, a clear unsubscribe mechanism, and accurate sender information.
        ...
        <div>
          ...
          <p>
            We will notify you of material changes via email or in-app notification at least
        ...
        <div>
          ...
          <p className="mt-1">{c.entityName} &middot; {c.physicalAddress}</p>
        </div>
      </section>
    </div>
  );
