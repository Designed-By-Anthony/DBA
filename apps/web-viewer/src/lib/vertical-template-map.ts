...
export function uiVerticalTemplateToSqlVerticalType(template: string | undefined): SqlVerticalType {
...
export function sqlVerticalTypeToUiTemplateFallback(sql: string | null | undefined): UiVerticalId {
  switch (sql) {
    case "service_pro":
      return "contractor";
    case "restaurant":
