...
import { getOnboardingProgress, completeOnboardingStep } from "@/app/admin/legal/actions";

const ONBOARDING_STEPS = [
  { id: "org_created", label: "Create Organization", description: "Set up your workspace", auto: true },
  { id: "legal_accepted", label: "Accept Terms & Privacy", description: "Review and accept our legal agreements", href: "/admin/legal/terms" },
  { id: "vertical_selected", label: "Select Your Industry", description: "Choose your vertical for a tailored experience", href: "/admin/settings" },
  { id: "first_lead", label: "Add First Lead", description: "Import or create your first contact", href: "/admin/clients" },
  { id: "email_setup", label: "Set Up Email", description: "Verify your sending domain", href: "/admin/settings" },
  { id: "stripe_connected", label: "Connect Payments", description: "Link Stripe for invoicing & POS", href: "/admin/settings" },
  { id: "pwa_installed", label: "Install Mobile App", description: "Get Agency OS on your phone", href: "#pwa" },
] as const;
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-1">
          ...
          {collapsed ? <ChevronUp size={16} className="text-white" /> : <ChevronDown size={16} className="text-white" />}
        </div>
      </div>
            ...
            return (
              ...
              >
                {done ? (
                  ...
                  <Circle size={20} className="text-[var(--color-text-muted)] flex-shrink-0 mt-0.5" />
                )}
                <div className="min-w-0">
                  <p className={`text-sm font-medium ${done ? "line-through text-[var(--color-text-muted)]" : "text-white"}`}>
                    {step.label}
                  </p>
