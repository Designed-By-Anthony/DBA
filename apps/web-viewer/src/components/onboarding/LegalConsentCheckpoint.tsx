...
import { acceptLegalAgreements } from "@/app/admin/legal/actions";
import { completeOnboardingStep } from "@/app/admin/legal/actions";
  ...
  return (
    <div className="max-w-lg mx-auto">
      ...
      <div className="space-y-4 mb-6">
        <label className="flex items-start gap-3 p-4 rounded-xl border border-[var(--color-glass-border)] hover:border-[var(--color-brand)] transition-colors cursor-pointer bg-[var(--color-surface-1)]">
          ...
          <div className="flex-1">
            <span className="text-sm text-white font-medium">Terms of Service</span>
        ...
        <label className="flex items-start gap-3 p-4 rounded-xl border border-[var(--color-glass-border)] hover:border-[var(--color-brand)] transition-colors cursor-pointer bg-[var(--color-surface-1)]">
          ...
          />
          <div className="flex-1">
            <span className="text-sm text-white font-medium">Privacy Policy</span>
            <p className="text-xs text-[var(--color-text-muted)] mt-0.5">
        ...
        <label className="flex items-start gap-3 p-4 rounded-xl border border-[var(--color-glass-border)] hover:border-[var(--color-brand)] transition-colors cursor-pointer bg-[var(--color-surface-1)]">
          ...
          />
          <div className="flex-1">
            <span className="text-sm text-white font-medium">Acceptable Use Policy</span>
            <p className="text-xs text-[var(--color-text-muted)] mt-0.5">
      ...
      <p className="text-xs text-center text-[var(--color-text-muted)] mt-4">
        By continuing, you consent to the processing of your data as described in our Privacy Policy.
      </p>
    </div>
  );
}
