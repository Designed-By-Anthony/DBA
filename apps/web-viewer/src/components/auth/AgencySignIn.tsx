...
/** Shared Clerk sign-in surface — used on `/sign-in` and inline when `/admin` is unauthenticated (no redirect hop). */
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-(--color-surface-0) p-4 relative overflow-hidden">
      ...
      <div className="relative text-center animate-scale-in">
        ...
        <p className="text-sm text-text-muted mb-8">Sign in to access your dashboard</p>
