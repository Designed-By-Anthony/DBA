...
if (!secret) {
  console.error("Set LEAD_EMBED_WIDGET_SECRET (same value as Vercel / .env.local).");
  process.exit(1);
}
...
console.log("sig:   ", sig);
console.log("");
console.log("Script tag (place before </body>, or next to <div id=\"dba-lead-form\"></div>):");
console.log(
