 ...
 */
export const SLA_HOURS_BY_PRIORITY: Record<
...
export function getTicketSlaState(
	...
	const p = (
		["urgent", "high", "medium", "low"].includes(priority) ? priority : "medium"
	) as keyof typeof SLA_HOURS_BY_PRIORITY;
