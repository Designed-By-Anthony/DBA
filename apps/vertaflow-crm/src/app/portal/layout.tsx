...
export const metadata: Metadata = {
	...
	description:
		"Manage your project, view milestones, and communicate with your development team.",
	appleWebApp: {
		capable: true,
...
export default function PortalLayout({
	...
	return (
		<div className="min-h-screen bg-(--color-surface-0) flex flex-col">
			...
			<main className="max-w-5xl mx-auto px-6 py-8 flex-1 page-enter">
				{children}
			</main>
			...
			<footer className="border-t border-glass-border py-6">
				<div className="max-w-5xl mx-auto px-6 flex items-center justify-between">
					<p className="text-[11px] text-text-muted">
						© {new Date().getFullYear()} Designed by Anthony · All rights
						reserved
					</p>
					<a
