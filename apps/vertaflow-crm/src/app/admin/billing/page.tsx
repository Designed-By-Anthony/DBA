					...
					<table className="w-full text-left text-sm">
						<thead>
							<tr className="border-b border-glass-border">
								<th className="px-5 py-3 text-xs text-text-muted uppercase tracking-wider font-medium">
									Client
								</th>
								<th className="px-5 py-3 text-xs text-text-muted uppercase tracking-wider font-medium">
									Type
								...
								<th className="px-5 py-3 text-xs text-text-muted uppercase tracking-wider font-medium hidden md:table-cell">
									Date
								</th>
							</tr>
						</thead>
						<tbody className="divide-y divide-glass-border">
							{filtered.map((inv) => (
								...
								>
									...
									<td className="px-5 py-3">
										<span
											className={`text-xs px-2.5 py-1 rounded-full border ${statusColors[inv.status] || ""}`}
										>
											{inv.status}
										</span>
									</td>
