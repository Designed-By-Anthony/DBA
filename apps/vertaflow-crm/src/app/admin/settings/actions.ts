...
export async function updateTenantSettings(
	...
	if (fields.verticalType !== undefined)
		payload.verticalType = fields.verticalType;
	if (fields.brandColor !== undefined) payload.brandColor = fields.brandColor;
	if (fields.brandLogoUrl !== undefined)
		payload.brandLogoUrl = fields.brandLogoUrl;
	if (fields.replyFromEmail !== undefined)
		payload.replyFromEmail = fields.replyFromEmail;
	if (fields.replyFromName !== undefined)
		payload.replyFromName = fields.replyFromName;
	if (fields.supportEmail !== undefined)
		payload.supportEmail = fields.supportEmail;
	if (fields.physicalAddress !== undefined)
		payload.physicalAddress = fields.physicalAddress;
	if (fields.pipelineStages !== undefined)
		payload.pipelineStages = fields.pipelineStages;
	if (fields.dealSources !== undefined)
		payload.dealSources = fields.dealSources;
	if (fields.notificationPrefs !== undefined)
		payload.notificationPrefs = fields.notificationPrefs;
