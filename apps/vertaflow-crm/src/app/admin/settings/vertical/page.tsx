...
const verticals: VerticalOption[] = [
	{
		...
		description:
			"Web design, marketing, consulting, photography. Pipeline: Lead → Contacted → Proposal → Development → Launched",
		emoji: "🎯",
	},
	{
		id: "service_pro",
		...
		description:
			"HVAC, plumbing, electrical, landscaping, cleaning. Pipeline: Request → Estimate → Scheduled → In Progress → Completed",
		emoji: "🏗️",
	},
];
		...
		<div className="space-y-8 max-w-2xl">
			<div>
				...
				<p className="text-xs text-text-muted mt-1">
					Choose your industry to customize terminology, pipeline stages, and
					sidebar navigation
				</p>
			</div>
			...
			<div className="p-4 rounded-xl border border-amber-500/20 bg-amber-500/5">
				<p className="text-xs text-amber-400">
					<strong>Note:</strong> Changing your vertical will update sidebar
					labels, pipeline stage names, and field terminology. Existing data is
					preserved — only the UI language changes.
				</p>
			</div>
