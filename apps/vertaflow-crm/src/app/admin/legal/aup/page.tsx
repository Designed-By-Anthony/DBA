			...
			<section className="space-y-6 leading-relaxed text-sm">
				<div>
					...
					<p>
						...
						{c.platformName}
						operated by {c.entityName}. This AUP supplements our Terms of
						Service.
					</p>
				</div>
				...
				<div>
					...
					<ul className="list-disc pl-6 mt-2 space-y-1">
						<li>
							Send unsolicited bulk email (spam) or violate CAN-SPAM, GDPR, or
							CASL
						</li>
						<li>
							Harvest or scrape email addresses, phone numbers, or other
							personal data
						</li>
						...
						<li>
							Use automated tools to overload, stress-test, or attack the
							platform
						</li>
						<li>
						...
						<li>
							Store or distribute content depicting child exploitation or abuse
						</li>
					</ul>
				</div>
				...
				<div>
					...
					<ul className="list-disc pl-6 space-y-1">
						...
						<li>
							Bounce rates exceeding 5% may result in temporary email suspension
						</li>
						<li>
							You must maintain a valid physical mailing address in all
							marketing emails
						</li>
					</ul>
				</div>
				...
				<div>
					...
					<ul className="list-disc pl-6 space-y-1">
						<li>
							You are responsible for the data you upload and must comply with
							applicable data protection laws
						</li>
						<li>
							Credit card numbers must not be stored in CRM notes, custom
							fields, or file attachments — use the integrated Stripe payment
							processing
						</li>
						<li>
							Social Security Numbers, driver&apos;s license numbers, and
							financial account numbers must not be stored in free-text fields
						</li>
					</ul>
				</div>
				...
				<div>
					...
					<ul className="list-disc pl-6 space-y-1">
						...
						<li>
							Integration credentials must be stored securely and never shared
							publicly
						</li>
					</ul>
				</div>
				...
				<div>
					...
					<p>
						Violations may result in: written warning, temporary feature
						restriction, account suspension, or permanent termination at our
						sole discretion. We will attempt to notify you before taking action,
						except in cases of imminent harm or legal obligation.
					</p>
				</div>
