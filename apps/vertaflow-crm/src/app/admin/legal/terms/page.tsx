		...
		<div className="max-w-3xl mx-auto py-12 px-6 text-[var(--color-text-secondary)]">
			...
			<section className="space-y-6 leading-relaxed text-sm">
				<div>
					...
					<p>
						By accessing or using {c.platformName} (the &ldquo;Platform&rdquo;),
						operated by <strong className="text-white">{c.entityName}</strong>{" "}
				...
				<div>
					...
					<p>
						{c.platformName} is a multi-tenant SaaS customer relationship
						management (CRM) platform that provides business management tools
						including but not limited to: lead management, point-of-sale,
						inventory tracking, appointment scheduling, email communications,
				...
				<div>
					...
					<p>
						Each organization (&ldquo;Tenant&rdquo;) operates in an isolated
						data environment. Your data is scoped exclusively to your
						organization and is not accessible by other tenants. We implement
						row-level security and tenant-scoped access controls.
					</p>
				</div>
				...
				<div>
					...
					<ul className="list-disc pl-6 mt-2 space-y-1">
						...
						<li>
							Send unsolicited commercial communications (spam) through the
							Platform
						</li>
						<li>
						...
						<li>
							Use the email features in violation of CAN-SPAM, GDPR, or CASL
							regulations
						</li>
					</ul>
				</div>
				...
				<div>
					...
					<p>
						...
						documentation, is owned by {c.entityName} and is protected by
						copyright, trademark, and other intellectual property laws. You
						retain ownership of your data and content uploaded to the Platform.
					</p>
				</div>
				...
				<div>
					...
					<p>
						...
						through Stripe. Subscription fees are non-refundable except as
				...
				<div>
					...
					<p>
						You may export or delete your data at any time. Upon account
						termination, we will retain your data for 30 days, after which it
						will be permanently deleted from our systems and backups.
					</p>
				</div>
				...
				<div>
					...
					<p>
						TO THE MAXIMUM EXTENT PERMITTED BY LAW, {c.entityName.toUpperCase()}{" "}
				...
				<div>
					...
					<p>
						You agree to indemnify and hold harmless {c.entityName}, its
				...
				<div>
					...
					<p>
						...
						the laws of the State of {c.jurisdiction}, without regard to its
				...
				<div>
					...
					<p>
						...
						least 30 days before they take effect. Continued use after changes
