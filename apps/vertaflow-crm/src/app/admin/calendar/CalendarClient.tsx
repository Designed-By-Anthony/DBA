...
import { type CalendarBooking, getCalendarBookings } from "./actions";
					...
					{CALENDLY_EMBED_URL ? (
						<div className="bg-surface-1 border border-glass-border rounded-2xl overflow-hidden">
							...
							<p className="text-[10px] text-text-muted px-4 py-2 border-t border-glass-border">
								Bookings still sync via your Calendly webhook into this CRM.
								Full event setup remains in Calendly.
							</p>
						</div>
					) : null}

					<div className="bg-amber-500/10 border border-amber-500/20 rounded-2xl p-6">
						<h2 className="font-semibold text-amber-500 mb-2">
							Deposits &amp; no-shows
						</h2>
