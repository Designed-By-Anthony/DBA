...
export default function NotificationOptIn() {
				...
				const sub = await registration.pushManager
					.subscribe({
						...
						applicationServerKey:
							process.env.NEXT_PUBLIC_FCM_VAPID_KEY ?? undefined,
					})
					.catch(() => null);
	...
	if (dismissed || permission === "denied" || typeof window === "undefined")
		return null;
			...
			<div className="flex items-start gap-3">
				...
				<div className="flex-1">
					...
					<p className="text-xs text-[var(--color-text-muted)] mt-0.5">
						Receive push notifications when we update your project or reply to a
						ticket — no email needed.
					</p>
