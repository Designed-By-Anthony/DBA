...
export default async function VerticalDashboard() {
	...
	const menu: RestaurantMenuItem[] = ((
		tenant?.crmConfig as TenantCrmConfigMenu | undefined
	)?.menu ?? []) as RestaurantMenuItem[];

	return (
		<div
			className="glass-card p-5 animate-fade-up"
			data-chameleon-vertical={vertical}
		>
			...
			<VerticalSwitch
				...
				restaurant={
					<RestaurantFeatureSet menu={menu} orders={restaurantOrders} />
				}
