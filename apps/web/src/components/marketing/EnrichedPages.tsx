...
export function AboutPage() {
	...
	return (
		<MarketingChrome footerCta={homeFooterCta}>
			...
			<section className="section-shell section-shell--wash">
				<div className="section-container marketing-cta-row marketing-cta-row--center reveal-up">
		...
		<MarketingChrome footerCta={homeFooterCta}>
			...
			<section className="section-shell">
				<div className="section-container">
					...
					<div className="marketing-cta-row marketing-cta-row--center reveal-up">
						<Link href="/lighthouse" className="btn btn-primary-book">
							Audit My Site
						</Link>
			...
			<section className="section-shell section-shell--wash">
				<div className="section-container">
					...
					<div className="comparison-grid">
						<article className="surface-card comparison-column comparison-column--them reveal-left">
						...
						<article className="surface-card comparison-column comparison-column--us reveal-right">
			...
			<section className="section-shell section-shell--wash">
				<div className="section-container">
					...
					<div className="stack-grid">
						<article className="surface-card stack-col reveal-up">
						...
						<article className="surface-card stack-col reveal-up">
							<span className="stack-col-label">Styling &amp; System</span>
							<div className="stack-chips">
								{[
									...
									{ label: "Semantic CSS", href: "/ouredge" },
								].map(({ label, href }) => (
									<a
										key={label}
										href={href}
		...
		<MarketingChrome footerCta={homeFooterCta}>
			...
			<section className="section-shell">
				<div className="section-container">
					...
					<div className="marketing-cta-row marketing-cta-row--center marketing-cta-row--spaced reveal-up">
			...
			<section className="section-shell section-shell--wash">
				<div className="section-container">
					<div className="service-area-signal-strip reveal-up">
						<article className="surface-card service-area-signal">
