  ...
  return (
    <div className="w-full relative">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div>
          <label htmlFor="url" className="block text-sm font-semibold text-label mb-1.5 tracking-wide">Website URL</label>
          <input
            id="url"
            name="url"
            type="text"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div>
            <label htmlFor="name" className="block text-sm font-semibold text-label mb-1.5 tracking-wide">Your Name</label>
            <input
              id="name"
              name="name"
              type="text"
          ...
          <div>
            <label htmlFor="company" className="block text-sm font-semibold text-label mb-1.5 tracking-wide">Company</label>
            <input
              id="company"
              name="company"
              type="text"
        ...
        <div>
          <label htmlFor="email" className="block text-sm font-semibold text-label mb-1.5 tracking-wide">Where should we send the report?</label>
          <input
            id="email"
            name="email"
            type="email"
        ...
        <div>
          <label htmlFor="location" className="block text-sm font-semibold text-label mb-1.5 tracking-wide">City & State</label>
          <input
            id="location"
            name="location"
            type="text"
        ...
        {status === "error" && (
          <div className="p-4 bg-danger/10 border border-danger/20 rounded-xl text-danger text-sm" aria-live="polite">
            {errorMsg}
          </div>
        )}
        ...
        <button
          ...
          className="w-full text-white font-bold text-lg rounded-xl px-4 py-4 mt-4 transition-all transform hover:-translate-y-0.5 cursor-pointer disabled:cursor-not-allowed disabled:opacity-70" style={{ background: 'linear-gradient(135deg, rgba(96, 165, 250, 0.34), rgba(37, 99, 235, 1))', border: '1px solid rgba(96, 165, 250, 0.55)', boxShadow: '0 22px 40px -22px rgba(37, 99, 235, 1), inset 0 1px 0 rgba(255, 255, 255, 0.22)' }}
        >
          Run Free Audit
        </button>
      </form>
