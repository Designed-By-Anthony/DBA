...
- **`SECURITY.md`:** Rewrote for this repo only (Netlify, `src/middleware.ts`, real API routes under `src/app/api/`); removed phantom `apps/web-viewer` and webhook tables that do not exist here.
